...
const _1 = __importDefault(__nccwpck_require__(594));
const compositeYan = async (imgSrc, yanSrc) => {
    const image = await _1.default.read(imgSrc);
    const yan = await _1.default.read(yanSrc);
...
const ascii_1 = __nccwpck_require__(850);
const image_1 = __nccwpck_require__(773);
